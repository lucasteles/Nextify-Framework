...
{
    public partial class PragmaMenuItemControl : PragmaUserControl
    {
        ...
        public void AddItems(List<PragmaMenuItem> childMenus)
        {
            foreach (var item in childMenus)
            {
                var subMenu = new PragmaMenuItemControl(item, Nivel + 1);
                AddItem(subMenu);
                subMenu.AddItems(item.ChildMenus);
            }
        }
        public void AddItem(PragmaMenuItemControl menuItem)
        {

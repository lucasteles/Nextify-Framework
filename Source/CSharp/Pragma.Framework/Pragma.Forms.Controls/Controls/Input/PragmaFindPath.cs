...
namespace Pragma.Forms.Controls
{
    ...
    public partial class PragmaFindPath : PragmaUserControl, IControl, IControlWithValidation<PragmaFindPath>
    {
        /// <summary>
        ...
        public IControlValidator<PragmaFindPath> Validator { get; set; }

        public PragmaFindPath()
        {
            SearchType = BrowserType.Directories;
            Extensions = "All Files|*.*";
            Validator = new ControlValidator<PragmaFindPath>(new PragmaFindPathValidation());
            InitializeComponent();
        }

...
{
    public static class NextifyColor
    {
        /// <summary>
        ...
        /// <summary>
        /// Vermelho do logo da Nextify
        /// </summary>
        public static Color VermelhoNextify = Color.FromArgb(192, 0, 0);

        public static Color CinzaLinhaDataGrid = Color.FromArgb(240, 240, 240);

        //LEMBRAR QUE O RED E O BLUE ESTÃO INVERTIDOS!
        public static int vermelhoNextify = Color.FromArgb(0, 0, 0, 192).ToArgb();

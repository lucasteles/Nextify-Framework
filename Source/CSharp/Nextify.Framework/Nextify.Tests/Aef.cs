...
namespace Nextify.Tests
{
    public static class Aef
    {
        ...
        public static void Configure<TModel>(DbContext context, IList<TModel> list) where TModel : class
        {
            A.CallTo(() => context.Set<TModel>()).Returns(FakeDbSet(list));

        }
        //public static void Configure(DbContext context, params IList<object>[] listOfLists)
        //{

        //    foreach (var list in listOfLists)
        //    {
        //        Configure(context, list);
        //    }
        //}

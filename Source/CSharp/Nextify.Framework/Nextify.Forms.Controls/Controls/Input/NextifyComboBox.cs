...
{
    public partial class NextifyComboBox : MetroComboBox, INextifyComboBox, IControlWithValidation<NextifyComboBox>
    {
        public NextifyComboBox()
        {
            InitializeComponent();
        }
        ...
        #region Metodos
        public IControlValidator<NextifyComboBox> Validator { get; set; }

...
namespace Nextify.Forms.Controllers.Abstraction
{
    ...
    {
        #region Propriedades
        private NextifyContextMenu MenuContext { get; set; }  // Menu de Contexto
        private NextifyContextMenu MenuSelection { get; set; }  // Menu da seleção do grid
        private NextifyContextMenu MenuEmptyGrid { get; set; }  // Menu da seleção do grid
        ...
        /// </summary>
        protected NextifyDataGrid PgmGrid { get; set; }
        ...
        protected AbstractGridController()
        {
            ...
            MenuSelection = new NextifyContextMenu();
        ...
        public virtual async Task UseAsync(INextifyDataGrid grid)
        {
        ...
        {
            MenuEmptyGrid = new NextifyContextMenu();
            MenuContext = new NextifyContextMenu();
